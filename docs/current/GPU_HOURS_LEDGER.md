...
|---|---|---|---|---|---|---|
| 2026-08-20 | M0 | owned RTX 5080 Laptop 16 GB | WP-C context/cap fit probe (3 server sessions, 3 full-cap stability generations) | TBD-WPC | 0 | filled at M0 close from m0_fit_probe events |
| 2026-08-20 | M0 | owned RTX 5080 Laptop 16 GB | WP-B paired cap-raise probe (31 generations, one session) | TBD-WPB | 0 | filled at M0 close from m0_paired_probe events |

...
CASES = [
  ...
  ('INT-CASE-002', 'clustered eval effective N', 'Stratum-clustered outcomes silently collapsed a held-out suite to a small fraction of its nominal item count; the headline model comparison was not significant cluster-robustly; power grows with the number of strata, not replications', ['04', '03']),

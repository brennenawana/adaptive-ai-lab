...
| INT-CASE-002 | **internal (source project)** — Case study: clustered eval effective N (`examples/CASE-002_clustered-eval-effective-n.md`) | Stratum-clustered outcomes silently collapsed a held-out suite to a small fraction of its nominal item count; the headline model comparison was not significant cluster-robustly; power grows with the number of strata, not replications | case-study | stable | 2026-08-21 |
